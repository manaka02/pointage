...
class EmployeTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('EmployeId', 'DepartementId', 'NomPrenom', 'Poste', 'Genre', ),
        self::TYPE_CAMELNAME     => array('employeId', 'departementId', 'nomPrenom', 'poste', 'genre', ),
        self::TYPE_COLNAME       => array(EmployeTableMap::COL_EMPLOYE_ID, EmployeTableMap::COL_DEPARTEMENT_ID, EmployeTableMap::COL_NOM_PRENOM, EmployeTableMap::COL_POSTE, EmployeTableMap::COL_GENRE, ),
        self::TYPE_FIELDNAME     => array('employe_id', 'departement_id', 'nom_prenom', 'poste', 'genre', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('EmployeId' => 0, 'DepartementId' => 1, 'NomPrenom' => 2, 'Poste' => 3, 'Genre' => 4, ),
        self::TYPE_CAMELNAME     => array('employeId' => 0, 'departementId' => 1, 'nomPrenom' => 2, 'poste' => 3, 'genre' => 4, ),
        self::TYPE_COLNAME       => array(EmployeTableMap::COL_EMPLOYE_ID => 0, EmployeTableMap::COL_DEPARTEMENT_ID => 1, EmployeTableMap::COL_NOM_PRENOM => 2, EmployeTableMap::COL_POSTE => 3, EmployeTableMap::COL_GENRE => 4, ),
        self::TYPE_FIELDNAME     => array('employe_id' => 0, 'departement_id' => 1, 'nom_prenom' => 2, 'poste' => 3, 'genre' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
