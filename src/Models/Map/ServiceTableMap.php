...
class ServiceTableMap extends TableMap
{
     ...
     */
    const OM_CLASS = '\\App\\Models\\Service';
     ...
     */
    const COL_SERVICE_ID = 'service.service_id';

    /**
     * the column name for the designation field
     */
    const COL_DESIGNATION = 'service.designation';
     ...
     */
    const COL_DEPARTEMENT_ID = 'service.departement_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('ServiceId', 'Designation', 'Description', 'DepartementId', ),
        self::TYPE_CAMELNAME     => array('serviceId', 'designation', 'description', 'departementId', ),
        self::TYPE_COLNAME       => array(ServiceTableMap::COL_SERVICE_ID, ServiceTableMap::COL_DESIGNATION, ServiceTableMap::COL_DESCRIPTION, ServiceTableMap::COL_DEPARTEMENT_ID, ),
        self::TYPE_FIELDNAME     => array('service_id', 'designation', 'description', 'departement_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('ServiceId' => 0, 'Designation' => 1, 'Description' => 2, 'DepartementId' => 3, ),
        self::TYPE_CAMELNAME     => array('serviceId' => 0, 'designation' => 1, 'description' => 2, 'departementId' => 3, ),
        self::TYPE_COLNAME       => array(ServiceTableMap::COL_SERVICE_ID => 0, ServiceTableMap::COL_DESIGNATION => 1, ServiceTableMap::COL_DESCRIPTION => 2, ServiceTableMap::COL_DEPARTEMENT_ID => 3, ),
        self::TYPE_FIELDNAME     => array('service_id' => 0, 'designation' => 1, 'description' => 2, 'departement_id' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Models\\Service');
        $this->setPackage('');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('service_id', 'ServiceId', 'INTEGER', true, null, null);
        $this->addColumn('designation', 'Designation', 'VARCHAR', true, 250, null);
        $this->addColumn('description', 'Description', 'LONGVARCHAR', false, null, null);
        $this->addForeignKey('departement_id', 'DepartementId', 'INTEGER', 'departement', 'departement_id', true, null, null);
    } // initialize()
  ...
  array (
    ...
    1 => ':departement_id',
        ...
        $this->addRelation('Unite', '\\App\\Models\\Unite', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':service_id',
    1 => ':service_id',
  ),
), 'CASCADE', null, 'Unites', false);
    } // buildRelations()
    /**
     * Method to invalidate the instance pool of all tables related to service     * by a foreign key with ON DELETE CASCADE
     */
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ServiceTableMap::COL_SERVICE_ID);
            $criteria->addSelectColumn(ServiceTableMap::COL_DESIGNATION);
            $criteria->addSelectColumn(ServiceTableMap::COL_DESCRIPTION);
            $criteria->addSelectColumn(ServiceTableMap::COL_DEPARTEMENT_ID);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Models\Service) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(ServiceTableMap::DATABASE_NAME);
            $criteria->add(ServiceTableMap::COL_SERVICE_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(ServiceTableMap::COL_SERVICE_ID) && $criteria->keyContainsValue(ServiceTableMap::COL_SERVICE_ID) ) {
