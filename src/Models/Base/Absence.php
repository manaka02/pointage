 ...
 */
abstract class Absence implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Models\\Map\\AbsenceTableMap';
    ...
    /**
     * Initializes internal state of App\Models\Base\Absence object.
     */
    ...
    /**
     * Compares this with another <code>Absence</code> instance.  If
     * <code>obj</code> is an instance of <code>Absence</code>, delegates to
     * <code>equals(Absence)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setAbsenceId($v)
    {
        ...
        if ($this->absence_id !== $v) {
            $this->absence_id = $v;
            $this->modifiedColumns[AbsenceTableMap::COL_ABSENCE_ID] = true;
        }
    ...
    public function setEmployeId($v)
    {
        ...
        if ($this->employe_id !== $v) {
            $this->employe_id = $v;
            $this->modifiedColumns[AbsenceTableMap::COL_EMPLOYE_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AbsenceTableMap::translateFieldName('AbsenceId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->absence_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AbsenceTableMap::translateFieldName('EmployeId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = AbsenceTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Models\\Absence'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAbsenceQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Absence::setDeleted()
     * @see Absence::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAbsenceQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AbsenceTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AbsenceTableMap::COL_ABSENCE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'absence_id';
        }
        if ($this->isColumnModified(AbsenceTableMap::COL_EMPLOYE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'employe_id';
        }
        if ($this->isColumnModified(AbsenceTableMap::COL_DATE_ABSENCE)) {
            $modifiedColumns[':p' . $index++]  = 'date_absence';
        }

        $sql = sprintf(
            'INSERT INTO absence (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'absence_id':
                        $stmt->bindValue($identifier, $this->absence_id, PDO::PARAM_INT);
                        break;
                    case 'employe_id':
    ...
    {
        $pos = AbsenceTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Absence'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Absence'][$this->hashCode()] = true;
        $keys = AbsenceTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Models\Absence
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setAbsenceId($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setEmployeId($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setDateAbsence($arr[$keys[2]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Models\Absence The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AbsenceTableMap::COL_ABSENCE_ID)) {
            $criteria->add(AbsenceTableMap::COL_ABSENCE_ID, $this->absence_id);
        }
        if ($this->isColumnModified(AbsenceTableMap::COL_EMPLOYE_ID)) {
            $criteria->add(AbsenceTableMap::COL_EMPLOYE_ID, $this->employe_id);
        }
        if ($this->isColumnModified(AbsenceTableMap::COL_DATE_ABSENCE)) {
            $criteria->add(AbsenceTableMap::COL_DATE_ABSENCE, $this->date_absence);
        }
    ...
    {
        $criteria = ChildAbsenceQuery::create();
        $criteria->add(AbsenceTableMap::COL_ABSENCE_ID, $this->absence_id);
    ...
    {
        $validPk = null !== $this->getAbsenceId();
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Models\Absence (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setDateAbsence($this->getDateAbsence());
        if ($makeNew) {
            $copyObj->setNew(true);
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Models\Absence Clone of current object.
     * @throws PropelException
     */
    ...
    public function getEmploye(ConnectionInterface $con = null)
    {
        if ($this->aEmploye === null && ($this->employe_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEmploye->addAbsences($this);
             */
        }
    ...
    {
        if (null !== $this->aEmploye) {
            $this->aEmploye->removeAbsence($this);
        }
        $this->absence_id = null;
        $this->employe_id = null;
        $this->date_absence = null;
        $this->alreadyInSave = false;
        $this->clearAllReferences();
        $this->resetModified();
        $this->setNew(true);
    ...
    {
        return (string) $this->exportTo(AbsenceTableMap::DEFAULT_STRING_FORMAT);
    }
