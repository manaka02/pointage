 ...
 */
abstract class Debauche implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Models\\Map\\DebaucheTableMap';
    ...
    /**
     * The value for the debauche_id field.
     *
     * @var        int
     */
    ...
    /**
     * Initializes internal state of App\Models\Base\Debauche object.
     */
    ...
    /**
     * Compares this with another <code>Debauche</code> instance.  If
     * <code>obj</code> is an instance of <code>Debauche</code>, delegates to
     * <code>equals(Debauche)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    /**
     * Get the [debauche_id] column value.
     *
     * @return int
     */
    public function getDebaucheId()
    {
        return $this->debauche_id;
    }
    ...
    /**
     * Set the value of [debauche_id] column.
     *
     * @param int $v New value
     * @return $this|\App\Models\Debauche The current object (for fluent API support)
     */
    public function setDebaucheId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->debauche_id !== $v) {
            $this->debauche_id = $v;
            $this->modifiedColumns[DebaucheTableMap::COL_DEBAUCHE_ID] = true;
        }
    ...
    public function setRefInterne($v)
    {
        ...
        if ($this->ref_interne !== $v) {
            $this->ref_interne = $v;
            $this->modifiedColumns[DebaucheTableMap::COL_REF_INTERNE] = true;
        }
    ...
    public function setNomPrenom($v)
    {
        ...
        if ($this->nom_prenom !== $v) {
            $this->nom_prenom = $v;
            $this->modifiedColumns[DebaucheTableMap::COL_NOM_PRENOM] = true;
        }
    ...
    public function setFonction($v)
    {
        ...
        if ($this->fonction !== $v) {
            $this->fonction = $v;
            $this->modifiedColumns[DebaucheTableMap::COL_FONCTION] = true;
        }
    ...
    public function setDepartementId($v)
    {
        ...
        if ($this->departement_id !== $v) {
            ...
            $this->modifiedColumns[DebaucheTableMap::COL_DEPARTEMENT_ID] = true;
        }
    ...
    public function setRaisons($v)
    {
        ...
        if ($this->raisons !== $v) {
            $this->raisons = $v;
            $this->modifiedColumns[DebaucheTableMap::COL_RAISONS] = true;
        }
    ...
    public function setMotif($v)
    {
        ...
        if ($this->motif !== $v) {
            $this->motif = $v;
            $this->modifiedColumns[DebaucheTableMap::COL_MOTIF] = true;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildDebaucheQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Debauche::setDeleted()
     * @see Debauche::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildDebaucheQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DebaucheTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(DebaucheTableMap::COL_NOM_PRENOM)) {
            $modifiedColumns[':p' . $index++]  = 'nom_prenom';
        }
        if ($this->isColumnModified(DebaucheTableMap::COL_FONCTION)) {
        ...
        if ($this->isColumnModified(DebaucheTableMap::COL_DATE_DEPART)) {
            $modifiedColumns[':p' . $index++]  = 'date_depart';
        }
        if ($this->isColumnModified(DebaucheTableMap::COL_RAISONS)) {
            $modifiedColumns[':p' . $index++]  = 'raisons';
        }
        if ($this->isColumnModified(DebaucheTableMap::COL_MOTIF)) {
            $modifiedColumns[':p' . $index++]  = 'motif';
        }

        $sql = sprintf(
            'INSERT INTO debauche (%s) VALUES (%s)',
    ...
    {
        $pos = DebaucheTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Debauche'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Debauche'][$this->hashCode()] = true;
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Models\Debauche
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Models\Debauche The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DebaucheTableMap::COL_NOM_PRENOM)) {
            $criteria->add(DebaucheTableMap::COL_NOM_PRENOM, $this->nom_prenom);
        }
        if ($this->isColumnModified(DebaucheTableMap::COL_FONCTION)) {
            $criteria->add(DebaucheTableMap::COL_FONCTION, $this->fonction);
        }
        if ($this->isColumnModified(DebaucheTableMap::COL_DEPARTEMENT_ID)) {
        ...
        if ($this->isColumnModified(DebaucheTableMap::COL_DATE_DEPART)) {
            $criteria->add(DebaucheTableMap::COL_DATE_DEPART, $this->date_depart);
        }
        if ($this->isColumnModified(DebaucheTableMap::COL_RAISONS)) {
            $criteria->add(DebaucheTableMap::COL_RAISONS, $this->raisons);
        }
        if ($this->isColumnModified(DebaucheTableMap::COL_MOTIF)) {
            $criteria->add(DebaucheTableMap::COL_MOTIF, $this->motif);
        }
    ...
    {
        $criteria = ChildDebaucheQuery::create();
        $criteria->add(DebaucheTableMap::COL_DEBAUCHE_ID, $this->debauche_id);
    ...
    {
        $validPk = null !== $this->getDebaucheId();
    ...
    /**
     * Generic method to set the primary key (debauche_id column).
     *
    ...
    {
        return null === $this->getDebaucheId();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Models\Debauche (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setDebaucheId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Models\Debauche Clone of current object.
     * @throws PropelException
     */
    ...
    public function getDepartement(ConnectionInterface $con = null)
    {
        if ($this->aDepartement === null && ($this->departement_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aDepartement->addDebauches($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(DebaucheTableMap::DEFAULT_STRING_FORMAT);
    }
